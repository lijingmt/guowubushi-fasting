export const translations = {
  zh: {
    ...
    p2pPrivacyNote: '隐私说明：排行榜使用P2P（点对点）技术，数据仅存储在用户设备本地。我们只共享匿名游戏数据（随机用户ID、功德值、完成天数），不收集任何个人信息。您可以随时在设置中关闭排行榜功能。',
    rank: '排名',
    nickname: '昵称',
  ...
  en: {
    ...
    p2pPrivacyNote: 'Privacy: The leaderboard uses P2P (peer-to-peer) technology, with data stored only on user devices locally. We only share anonymous game data (random user ID, merit points, completed days). We do not collect any personal information. You can disable the leaderboard in settings at any time.',
    rank: 'Rank',
    nickname: 'Nickname',
  ...
  es: {
    ...
    p2pPrivacyNote: 'Privacidad: La tabla de clasificación utiliza tecnología P2P (punto a punto), con datos almacenados solo en los dispositivos de los usuarios localmente. Solo compartimos datos de juego anónimos (ID de usuario aleatorio, puntos de mérito, días completados). No recopilamos información personal. Puede desactivar la tabla de clasificación en la configuración en cualquier momento.',
    rank: 'Rango',
    nickname: 'Apodo',
